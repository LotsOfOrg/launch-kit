...
Launch Kit uses [nbdev](https://nbdev.fast.ai/) for development. Here’s
how to contribute:
...
**Important**: Never edit files in `launch_kit/` directly - they’re
...
[LICENSE](https://github.com/LotsOfOrg/launch-kit/blob/main/LICENSE) for
details.
